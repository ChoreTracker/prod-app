...
public class ProdPopulator implements CommandLineRunner {
	...
	User user = new User("Parent", "admin", "contact", "ADMIN", "USER");
	User user2 = new User("Child", "user", "contact2", "USER");
	userRepo.save(user);
	userRepo.save(user2);
	...
	Mission mission = new Mission("MissionName", "description", sector, 1, 2, "2018-12-25", null, true, 0, user);
	Mission mission2 = new Mission("MissionName2", "description2", sector, 4, 3, "2018-11-30", null, true, 0,
			user);
	...
	Mission mission5 = new Mission("wash dog", "wash him real good", sector4, 1,3, "2018-12-12", null, false, 0, user2);
    Mission mission6 = new Mission("wash cat", "try it and see", sector5, 1,4, "2018-12-13", null, false, 0, user2);
    Mission mission7 = new Mission("rake leaves", "rake them real good", sector6, 1,3, "2018-12-01", null, true, 0, user);
    Mission mission8 = new Mission("dishes", "scrub", sector2, 1,3, "2018-12-01", null, true, 0, user2);
    Mission mission9 = new Mission("laundry", "wash dry fold put away", sector5, 5,2, "2018-11-30", null, true, 0, user2);
